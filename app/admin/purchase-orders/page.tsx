...
export default function PurchaseOrdersPage() {
  ...
  const handleCancelPurchaseOrder = (purchaseOrder: PurchaseOrderResponse) => {
      ...
      render: (_value, row) => (
        <div className="flex justify-center gap-2">
          ...
          <Button
            size="sm"
            variant="outline"
            onClick={() => router.push(`/admin/purchase-orders/${row.id}/edit`)}
  ...
  return (
    <div className="p-4 md:p-8 space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-foreground">Đơn mua hàng</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="gap-0">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {
                purchaseOrders?.items?.filter((p) => p.status === "Draft")
                  .length
              }
            </div>
          </CardContent>
        ...
        <Card className="gap-0">
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {
                purchaseOrders?.items?.filter((p) => p.status === "Submitted")
                  .length
              }
            </div>
          </CardContent>
      ...
      <Card>
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div>
              <label className="text-sm font-medium mb-2 block">Nhà kho</label>
